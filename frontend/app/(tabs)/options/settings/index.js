        ...
        <SafeAreaView className="h-screen bg-white px-4">
                ...
                headerLeft: () => (
                    ...
                    className="ml-2 p-2 justify-center">
                        <View className="absolute -left-7">
                            <MaterialCommunityIcons name="chevron-left" color={"#15803d"} size={40}/>
                        </View>
                        <Text className="text-lg text-emerald-700 font-semibold">Back</Text>
                    </TouchableOpacity>
                )
            }}/>
            ...
            >
                ...
                <View className="pl-4 pr-3 space-y-4">
                    ...
                    <TouchableOpacity className="flex flex-row justify-between items-center py-4 pl-4 pr-2 bg-white shadow-md rounded-lg"
                    onPress={() => { router.push({ pathname: `/options/permits`, params: { category: "Permits" }})}}
                    >
                        <MaterialCommunityIcons name="badge-account-outline" color={"black"} size={30}/>
                        <Text className="text-lg font-medium">Permits</Text>
                        <MaterialCommunityIcons name="chevron-right" color={"black"} size={30} />
                    </TouchableOpacity>

                    <TouchableOpacity className="flex flex-row justify-between items-center py-4 pl-4 pr-2 bg-white shadow-md rounded-lg"
                    onPress={() => { router.push({ pathname: `/options/picture`, params: { category: "Picture" }})}}
                    >
                        <MaterialCommunityIcons name="image" color={"black"} size={30}/>
                        <Text className="text-lg font-medium">Profile Picture</Text>
                        <MaterialCommunityIcons name="chevron-right" color={"black"} size={30} />
                    </TouchableOpacity>

                    <TouchableOpacity className="flex flex-row justify-between items-center py-4 pl-4 pr-2 bg-white shadow-md rounded-lg"
                    onPress={() => { router.push({ pathname: `/options/email`, params: { category: "Email" }})}}
                    >
                    ...
                    <TouchableOpacity className="flex flex-row justify-between items-center py-4 pl-4 pr-2 bg-white shadow-md rounded-lg"
                    onPress={() => { router.push({ pathname: `/options/password`, params: { category: "Password" }})}}
                    >
